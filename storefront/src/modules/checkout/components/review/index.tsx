          ...
          <div className="flex items-start gap-x-1 w-full mb-6">
            <div className="w-full">
              <Text className="txt-medium-plus text-ui-fg-base mb-1">
                Al hacer clic en el botón Realizar pedido, confirma que ha leído, comprende y acepta 
                nuestros Términos de uso, Condiciones de venta y Política de devoluciones, y reconoce
                que ha leído la Política de privacidad de Medusa Store.
              </Text>
            </div>
          </div>
